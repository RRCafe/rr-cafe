...
export default function Cart() {
  ...
  const showAlert = (title, message, isError = true) => setModalConfig({ isOpen: true, title, message, isError });
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const grandTotal = subtotal + (deliveryData ? deliveryData.total_delivery_charge : 0);
                  ...
                  <div className="pt-2">
                    ...
                    <div className="h-64 bg-gray-100 rounded-lg overflow-hidden relative border">
                      <Map
                        ...
                        onClick={(ev) => !isCalculated && setPinLocation(ev.detail.latLng)}
